...
openssl genpkey -algorithm RSA -out ssl/key.key

# Generate a certificate signing request (CSR)
openssl req -new -key ssl/key.key -out ssl/cert.csr

# Generate a self-signed certificate
openssl x509 -req -days 365 -in ssl/cert.csr -signkey ssl/key.key -out ssl/cert.crt